...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$target_path = ($_SERVER['DOCUMENT_ROOT'] . "/shop/product_images/" . $fileName);
    ...
    if(empty($cat_id_err) && empty($brand_id_err) && empty($product_title_err) && empty($product_price_err) && empty($product_desc_err) && empty($product_keywords_err)&& empty($product_image_err)){ 
        ...
        if($stmt = mysqli_prepare($con, $sql)){
            ...
            mysqli_stmt_bind_param($stmt, "sssssss", $param_cat_id ,$param_brand_id ,$param_product_title ,
									$param_product_price ,$param_product_desc ,$param_product_image, $param_product_keywords);
						...
						<?php //echo $_SERVER['DOCUMENT_ROOT'];?>
							<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"  enctype="multipart/form-data">
								...
								<div class="form-group <?php echo (!empty($cat_id_err)) ? 'has-error' : ''; ?>">
									...
									?>
										<option value="<?php echo $row_cat['cat_id']; ?>"> <?php if($cat_id!=''){echo $cat_id;}else{echo  $row_cat['cat_title']; }?></option>
									<?php 
								...
								<div class="form-group <?php echo (!empty($brand_id_err)) ? 'has-error' : ''; ?>">
									...
									?>
										<option value="<?php echo $row_brand['brand_id']; ?>">  <?php if($brand_id!=''){echo $brand_id;}else{echo  $row_brand['brand_title']; }?></option>
									<?php 
												}
											}
										}	
